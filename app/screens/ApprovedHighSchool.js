...
const ApprovedHighSchool = () => {
  ...
  const fetchApprovedApplicants = () => {
    fetch("https://ngcdf.onrender.com/high-school/approved")
...
export default ApprovedHighSchool;
